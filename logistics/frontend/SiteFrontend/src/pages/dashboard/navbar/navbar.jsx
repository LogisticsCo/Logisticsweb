  ...
  return (
    <nav>
      <div class="flex flex-wrap items-center mx-auto">
        ...
        <div class="px-4 py-2 w-full flex items-center justify-between rtl:space-x-reverse">
          <button
            type="button"
        ...
        <div
          ...
          id="navbar-user"
        >
          <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 rtl:space-x-reverse">
            <li>
              <a
                href="#"
